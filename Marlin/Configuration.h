...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender5Plus, guitar24t)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "T195Ender5+"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 10, 50 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 1600, 1600, 20, 100 } // ...or, set your own edit limits
#endif
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (40*80)
#define HOMING_FEEDRATE_Z  (20*80)
